...
source: https://zan.gov.kz/client/#!/doc/78301/rus/18.02.2014
---
...
10. Уполномоченный орган оказывает без учета дохода:
    ...
    2) единовременную социальную помощь:
       ...
       для категории, указанной в абзаце третьем подпункта 6) пункта 9 настоящих Правил в размере 17619 (семнадцать тысяч шестьсот девятнадцать) тенге на основании заявления в уполномоченный орган или акиму села, сельского округа с приложением документов, указанных в подпунктах 1), 2) пункта 15 настоящих Правил;
       ...
       для категории, указанной в абзаце четвертом подпункта 9) пункта 9 настоящих Правил в размере 10 МРП на основании заявления в уполномоченный орган или акиму села, сельского округа с приложением документов, указанных в подпунктах 1), 2) пункта 15 настоящих Правил;
    ...
    4) ежеквартальную социальную помощь:
       ...
       > *Сноска. Пункт 10 с изменениями, внесенными решением маслихата Качирского района Павлодарской области от 26.09.2014 N 2/33 (вводится в действие по истечении десяти календарных дней после дня его первого официального опубликования).*
...
11. Уполномоченный орган оказывает с учетом дохода:
    ...
    1) единовременную социальную помощь:
       ...
       для категории, указанных в абзаце втором подпункта 9), абзаце втором подпункта 10) пункта 9 настоящих Правил на развитие личного подворья в размере до 110 МРП, на приобретение грубых кормов в размере 11 МРП на основании заявления в уполномоченный орган или акиму села, сельского округа с приложением документов, указанных в пункте 15 настоящих Правил, акта обследования жилищно-бытовых условий;

       для категории, указанной в абзаце втором подпункта 9) пункта 9 настоящих Правил в размере 17619 (семнадцать тысяч шестьсот девятнадцать) тенге на основании заявления в уполномоченный орган или акиму села, сельского округа с приложением документов, указанных в пункте 15 настоящих Правил;

       для категории, указанной в абзаце первом подпункта 10) пункта 9 настоящих Правил на лечение в размере до 10 месячных расчетных показателей на основании заявления в уполномоченный орган или акиму села, сельского округа с приложением документов, указанных в пункте 15 настоящих Правил, заключение специальной комиссии, справки с медицинского учреждения;
